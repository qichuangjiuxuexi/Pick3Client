...
#pragma warning disable 0649
    ...
    public class Settings : ScriptableObject
    {
        ...
        internal const string LocalResourcesName = "LocalSettings";
...
//#endif
        ...
        {
            var instance =  Resources.Load<Settings>("SRDebugger/" + LocalResourcesName);
            if (instance == null)
            {
                instance = Resources.Load<Settings>("SRDebugger/" + ResourcesName);
            }
            return instance;
        }
