...
namespace SRDebugger.UI.Controls.Data
{
    ...
    public class NumberControl : DataBoundControl
    {
        ...
        {
            typeof (int), typeof (short), typeof (byte), typeof (sbyte), typeof (uint), typeof (ushort),typeof(Int16),
        ...
        public static readonly Dictionary<Type, ValueRange> ValueRanges = new Dictionary<Type, ValueRange>
        {
            ...
            {typeof (Int64), new ValueRange {MaxValue = int.MaxValue, MinValue = int.MinValue}},
        };
