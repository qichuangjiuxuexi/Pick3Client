...
namespace GooglePlayGames.Editor
{
    ...
    public static class GPGSUtil
    {
        ...
        public static string RootPath
        {
            get
            {
                if (string.IsNullOrEmpty(mRootPath))
                {
                    ...
                    string[] dir1 = Directory.GetDirectories("../GhostStudioGameSDK", RootFolderName, SearchOption.AllDirectories);
        ...
        {
            string depPath =
                SlashesToPlatformSeparator(Path.Combine("Assets/GooglePlayGames",
                    "Editor/GooglePlayGamesPluginDependencies.xml"));
            Debug.Log("CheckAndFixDependencies："+depPath);
