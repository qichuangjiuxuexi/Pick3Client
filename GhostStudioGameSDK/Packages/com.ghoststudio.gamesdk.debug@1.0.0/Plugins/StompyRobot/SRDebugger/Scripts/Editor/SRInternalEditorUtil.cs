...
namespace SRDebugger.Editor
{
    ...
    static class SRInternalEditorUtil
    {
        ...
        public static class EditorSettings
        {
            ...
            internal const string LocaleSettingsFilePath = "Assets/Resources/SRDebugger/LocalSettings.asset";
            ...
            {
                if (File.Exists(LocaleSettingsFilePath))
                {
                    return LocaleSettingsFilePath;
                }
                else
                {
                    return SRInternalEditorUtil.GetAssetPath(SettingsFilePath);
                }
            }
